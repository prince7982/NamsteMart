...
<%@ page 
    import="com.namastemart.service.impl.*,com.namastemart.service.*,com.namastemart.beans.*,java.util.*,
...
<div class="products" style="background-color: #f1cdf6;">
    <div class="tab" align="center">
        <form>
            ...
            <br><br>
            <button type="submit" formaction="updateProductById.jsp">Update Products</button>
            <br><br>
        </form>
    </div>
</div>
